...
#### 3-2. Replicate the selecting process by another ML models: Random forest tree and SVM.
```{r message=F, warning=F}
...
#### 3-3. Create the significant associated variable list based on Random foreast and GLM model 
...
##### 4-2. Create original GlM Model based on top 6 significant variables which are also overlapped in RF result 
```{r message=F, warning=F}
